...
def decode():
    ...
    control_file = pd.read_csv(r"C:\Users\sanya\Desktop\Vasu Bansal\CS204_Course Project\CS204_CourseProject\src\test\control.csv")
    if opcode == 51:
...
def terminate():
    OutputFile_txt(r"C:\Users\sanya\Desktop\Vasu Bansal\CS204_Course Project\CS204_CourseProject\src\test\abc.txt")
    exit(1)
...
if __name__ == "__main__":
    read_from_file(r"C:\Users\sanya\Desktop\Vasu Bansal\CS204_Course Project\CS204_CourseProject\src\test\nsum.mc")
    while (True):
        fetch()
        decode()
        execute()
